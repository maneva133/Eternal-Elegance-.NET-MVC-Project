    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult AddUserToRole(AddToRoleModel model)
        {
            try
            {
                ...
                else
                {
                    foreach (var error in roleResult.Errors)
                    {
                        ...
                        // Example: logger.LogError($"Error adding user to role: {error}");
                    }
                }
            }
            catch (Exception ex)
            {
                ...
                // Example: logger.LogError(ex, "Exception occurred while adding user to role.");
                ModelState.AddModelError("", "An error occurred while adding the user to the role.");
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    using (var context = new ApplicationDbContext())
                    {
                        ...
                        var existingCustomer = context.Customers.SingleOrDefault(c => c.Email == model.Email);
